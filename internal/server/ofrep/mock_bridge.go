...
// OFREPBulkEvaluation provides a mock function with given fields: ctx, input
func (_m *MockBridge) OFREPBulkEvaluation(ctx context.Context, input EvaluationBridgeInput) ([]EvaluationBridgeOutput, error) {
	ret := _m.Called(ctx, input)

	if len(ret) == 0 {
		panic("no return value specified for OFREPBulkEvaluation")
	}
